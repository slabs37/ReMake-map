Shader "Custom/OutlineNote"
{
    Properties
    {
        ...
        */
        _Colour ("Note Colour", Color) = (1,1,1)
    ...
    SubShader
    {
        ...
        */
        ...
        Pass
        {
            ...
            UNITY_DEFINE_INSTANCED_PROP(float3, _Colour)
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 Colour = UNITY_ACCESS_INSTANCED_PROP(Props, _Colour);
                ...
                float nois = simplex((i.localPos * 2) + _Time.y * 0.3);
                float lighting = pow(i.localPos.y + 0.8, 2);
                float edges = pow(dot(i.localPos, i.coord) + 0.7, 16);
                return float4(Colour * edges, 0);
