Shader "Custom/SaberEdge"
{
    Properties
    {
        ...
        */
        ...
        _ColorDel ("Del Color", Color) = (0,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            UNITY_DEFINE_INSTANCED_PROP(float3, _ColorDel)
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 ColorDel = UNITY_ACCESS_INSTANCED_PROP(Props, _ColorDel);

                float3 viewDir = normalize(_WorldSpaceCameraPos - i.worldPos);
                half rim =  1-saturate(dot(normalize(viewDir), normalize(i.normal)));
                float3 finalColor = lerp(Color.bgr, Color.rgb, pow(rim, 0.1));
                finalColor = pow(finalColor, _RimPower);
                finalColor = finalColor - ColorDel;
                ...
                float alph = (finalColor.r + finalColor.g + finalColor.b)-(1-_Glow);
