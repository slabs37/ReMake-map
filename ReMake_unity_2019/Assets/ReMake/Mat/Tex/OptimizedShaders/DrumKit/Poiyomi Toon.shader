Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/c2d1b95c8ce515843b26180824e9afdf"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.537 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.706 /*_MochieMetallicMultiplier*/);
				...
				specularMask *= (1.56 /*_MochieSpecularStrength*/);
